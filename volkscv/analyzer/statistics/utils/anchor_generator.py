...
class AnchorGenerator:
    ...
    def __init__(self,
        ...
        self._strides = [_pair(stride) for stride in strides]
    ...
    @base_anchors.setter
    def base_anchors(self, v):
        """
        Args:
            new_values (list): A list of anchors.
        """
        if not isinstance(v, list):
            v = [v]
        self._base_anchors = [torch.tensor(v) for v_ in v]
    ...
    @strides.setter
    def strides(self, v):
        self._strides = [_pair(stride) for stride in v]
